    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="flex flex-col items-center justify-center text-center px-8 pt-12 pb-8">
        ...
        <p className="text-gray-400 text-lg max-w-lg mb-2">
          Higher verification = Higher UBI rewards
        </p>
      </section>
        ...
        <section className="max-w-md mx-auto text-center px-8 py-16">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
            ...
            <p className="text-gray-500 text-sm mb-6">
              Connect your wallet to see your verification status and upgrade your level.
            </p>
            <ConnectButton client={client} chain={polygonAmoy} />
          </div>
        </section>
                ...
                <div
                  ...
                  className={`border rounded-xl p-6 transition-all ${
                    isComplete
                      ...
                      : isNext
                      ? "bg-gray-900 border-purple-700 ring-1 ring-purple-500"
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      ...
                      {isNext && (
                        <span className="text-purple-300 text-xs">Available</span>
                      )}
                      {!isComplete && !isNext && (
